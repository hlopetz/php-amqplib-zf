...
class AMQP_Connection extends AMQP_Channel_Abstract
{
                                ...
                                $read_write_timeout = 3)
    {
        ...
        while(true)
        {
            ...
            AMQP_Misc::debug_msg("closing socket");
    ...
    {
        AMQP_Misc::debug_msg("< [hex]:\n" .
                            AMQP_Misc::hexdump($data, $htmloutput = false, $uppercase = true, $return = true));
    ...
    protected function send_channel_method_frame($channel, $method_sig, $args="")
    {
        ...
        AMQP_Misc::debug_msg("< " . AMQP_Misc::methodSig($method_sig) . ": " .
    ...
    protected function open_ok($args)
    {
        ...
        AMQP_Misc::debug_msg("Open OK! known_hosts: " . $this->known_hosts);
        return NULL;
    }
    ...
    protected function redirect($args)
    {
        ...
        $this->known_hosts = $args->read_shortstr();
        AMQP_Misc::debug_msg("Redirected to [". $host . "], known_hosts [" . $this->known_hosts . "]" );
        return $host;
    }
    ...
    protected function start($args)
    {
        ...
        AMQP_Misc::debug_msg(sprintf("Start from server, version: %d.%d, properties: %s, mechanisms: %s, locales: %s",
                          $this->version_major,
                          $this->version_minor,
