...
class AMQP_Channel extends AMQP_Channel_Abstract
{
                                ...
                                $auto_decode=true)
    {
        ...
        AMQP_Misc::debug_msg("using channel_id: " . $channel_id);

        parent::__construct($connection, $channel_id);

        $this->METHOD_MAP = self::$METHOD_MAP;
    ...
    {
        $this->is_open = true;
        AMQP_Misc::debug_msg("Channel open");
    }
